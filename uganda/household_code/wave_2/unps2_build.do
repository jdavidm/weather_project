...
* define paths
	loc		rootw 	= 	"$data/weather_data/uganda/wave_2/refined"
	loc		rooth 	= 	"$data/household_data/uganda/wave_2/refined"
	loc		export 	= 	"$data/merged_data/uganda/wave_2"
...
* define local with all sub-folders in it
	loc 		folderList : dir "`rootw'" dirs "unpsy2_rf*"
...
* define local with all sub-folders in it
	loc 		folderList : dir "`rootw'" dirs "unpsy2_t*"
...
* save file
	customsave 	, idvar(hhid) filename("unps2_merged.dta") ///
		path("`export'") dofile(unps2_build) user($user)
