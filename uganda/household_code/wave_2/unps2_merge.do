...
* encode the string location data
	...
	order			hhid prcid pltid region district districtdstrng county ///
						...
						wgt10 vl_hrv plotsize labordays fert_any fert irr_any ///
