...
order	reg_id country depvar sat varname regname
sort 	country depvar sat varname regname
...
* save complete results
	...
	customsave 	, idvarname(reg_id) filename("ea_complete_results.dta") ///
