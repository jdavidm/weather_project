...
* create file to post results to
	tempname 	reg_results_mvs_test
	postfile 	`reg_results_mvs_test' country str3 varrm str3 satrm str2 extrm ///
					...
					using "`results'/reg_results_mvs_test.dta", replace
								...
								* define locals for temperature variance naming conventions
									...
									* set conditionals
										...
										* weather
											...
											post 		`reg_results_mvs_test' (`l') ("`varrm'") ("`satrm'") ("`extrm'") ///
...
* close the post file and open the data file
	postclose	`reg_results_mvs_test' 
	use 		"`results'/reg_results_mvs_test", clear
