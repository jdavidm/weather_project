...
*temp regressions
local fileList : dir "`root'" files "lp*tp*.dta" 
...
mean_season- z_gdd data y2_hhid y3_hhid
...
clear all
*/
save "`results'/appended_lp_tp.dta", emptyok replace

loc fileList : dir "`export'" files "myresults_lp*tp*" 
foreach file in `fileList'{
...
save "`results'/appended_lp_tp.dta", replace
