...
loc export = "C:\Users/$user\Dropbox\Weather_Project\data\Malawi\results"


local fileList : dir "`root'" files "sp*rf*.dta" 
...
keep mean_season median_season sd_season total_season skew_season norain raindays raindays_percent ///
dry dev_total_season z_total_season dev_raindays dev_norain dev_raindays_percent ///
...
case_id region district urban ea_id strata cluster intmonth intyear
...
*IN THE PANEL ENVIRONMENT NEED TO SET PANEL
...
foreach v of varlist `rainfall' {
	qui: xtreg lnrs_harvest_valuehaimp `v'
	post `myresults' ("rs") ("reg1") ("`v'") (`=_b[`v']') (`=_se[`v']') (`=e(r2_a)') (`=e(ll)') (`=e(df_r)')
} 
*-rainfall variables and fe 			
foreach v of varlist `rainfall' {
	qui: xtreg lnrs_harvest_valuehaimp `v', fe
	post `myresults' ("rs") ("reg1") ("`v'") (`=_b[`v']') (`=_se[`v']') (`=e(r2_a)') (`=e(ll)') (`=e(df_r)')
}
*-rainfall variables and inputs and fe 	
foreach v of varlist `rainfall' {
	qui: xtreg lnrs_harvest_valuehaimp `v' `inputsrs' , fe 
	post `myresults' ("rs") ("reg2") ("`v'") (`=_b[`v']') (`=_se[`v']') (`=e(r2_a)') (`=e(ll)') (`=e(df_r)')
} 
*-rainfall and squared rainfall
foreach v of varlist `rainfall' {
	qui: xtreg lnrs_harvest_valuehaimp c.`v'##c.`v'
	post `myresults' ("rs") ("reg3") ("`v'") (`=_b[`v']') (`=_se[`v']') (`=e(r2_a)') (`=e(ll)') (`=e(df_r)')
} 
*-rainfall and squared rainfall and fe
foreach v of varlist `rainfall' {
	qui: xtreg lnrs_harvest_valuehaimp c.`v'##c.`v', fe
	post `myresults' ("rs") ("reg3") ("`v'") (`=_b[`v']') (`=_se[`v']') (`=e(r2_a)') (`=e(ll)') (`=e(df_r)')
} 
*-rainfall and squared rainfall and inputs and fe
foreach v of varlist `rainfall' {
	qui: xtreg lnrs_harvest_valuehaimp c.`v'##c.`v' `inputsrs', fe
...
*-rainfall variables 		
foreach v of varlist `rainfall' {
	qui: xtreg lnrsmz_harvesthaimp `v' 
	post `myresults' ("rsmz") ("reg1") ("`v'") (`=_b[`v']') (`=_se[`v']') (`=e(r2_a)') (`=e(ll)') (`=e(df_r)')
} 	
*-rainfall variables and fe	
foreach v of varlist `rainfall' {
	qui: xtreg lnrsmz_harvesthaimp `v', fe 
	post `myresults' ("rsmz") ("reg1") ("`v'") (`=_b[`v']') (`=_se[`v']') (`=e(r2_a)') (`=e(ll)') (`=e(df_r)')
} 		
*-rainfall variables and inputs and fe	
foreach v of varlist `rainfall' {
	qui: xtreg lnrsmz_harvesthaimp `v' `inputsrsmz', fe 
	post `myresults' ("rsmz") ("reg2") ("`v'") (`=_b[`v']') (`=_se[`v']') (`=e(r2_a)') (`=e(ll)') (`=e(df_r)')
} 		
*-rainfall and squared rainfall
foreach v of varlist `rainfall' {
	qui: xtreg lnrsmz_harvesthaimp c.`v'##c.`v'
	post `myresults' ("rsmz") ("reg3") ("`v'") (`=_b[`v']') (`=_se[`v']') (`=e(r2_a)') (`=e(ll)') (`=e(df_r)')
} 
*-rainfall and squared rainfall and fe
foreach v of varlist `rainfall' {
	qui: xtreg lnrsmz_harvesthaimp c.`v'##c.`v', fe
	post `myresults' ("rsmz") ("reg3") ("`v'") (`=_b[`v']') (`=_se[`v']') (`=e(r2_a)') (`=e(ll)') (`=e(df_r)')
} 
*-rainfall and squared rainfall and inputs and fe
foreach v of varlist `rainfall' {
	qui: xtreg lnrsmz_harvesthaimp c.`v'##c.`v' `inputsrsmz', fe
...
save "`export'/appended_sp_rf.dta", emptyok replace

loc fileList : dir "`root'" files "myresults_sp*" 
foreach file in `fileList'{
	append using "`root'/`file'" 
}

save "`export'/appended_sp_rf.dta", replace

		
/*

NEED TO ADD TEMPERATURE - start with this
