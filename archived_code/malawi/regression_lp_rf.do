...
loc root = "C:\Users/$user\Dropbox\Weather_Project\regressions"

*Establish location of individual regression results
loc export = "C:\Users/$user\Dropbox\Weather_Project\results\individual_results"

*Establish location of complete results
loc results = "C:\Users/$user\Dropbox\Weather_Project\results"

/*Rainfall regressions
local fileList : dir "`root'" files "lp*rf*.dta" 
...
mean_season- dev_raindays_percent data- y2_hhid y3_hhid
...
*/
save "`results'/appended_lp_rf.dta", emptyok replace

loc fileList : dir "`export'" files "myresults_lp*rf*" 
foreach file in `fileList'{
...
save "`results'/appended_lp_rf.dta", replace
