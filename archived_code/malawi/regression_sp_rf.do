...
mean_season- dev_raindays_percent data- y2_hhid 
...
save "`results'/appended_sp_rf.dta", emptyok replace

loc fileList : dir "`export'" files "myresults_sp*rf*" 
foreach file in `fileList'{
...
save "`results'/appended_sp_rf.dta", replace
