...
**********************************************************************************
**	UNPS 2013 (Wave 4) - Agriculture Section 2A 
**********************************************************************************
...
*	Correlation is high! (0.81)
summarize plotsize_gps plotsize_self
pwcorr plotsize_gps plotsize_self if inrange(plotsize_gps,0,8.86) & inrange(plotsize_self,0,8.86)
*	Correlation is slightly higher within this range (0.83)
...
summarize 
sort parcel_id
save "`export'/2013_AGSEC2A", replace
