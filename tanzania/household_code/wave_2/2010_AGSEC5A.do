...
* drop variables to create village-crop panel
	keep		crop_code crop_num region- ea ///
...
* merge price data back into dataset
	...
	*** price for crops at village-crop level (p_v): 1,624 missing
	*** price for crops at ward-crop level (p_w): 1,191 missing
	*** price for crops at district-crop level (p_d): 701 missing
	*** price for crops at region-crop level (p_r): 252 missing
	*** price for crops at country-crop level (p_c): 6 missing

* 6 missing values to drop
	drop		if p_c == .
