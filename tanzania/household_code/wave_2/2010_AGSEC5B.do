...
* does
	* cleans Tanzania household variables, wave 2 Ag sec5b
...
* open log
	log using "$logout/wv2_AGSE5B", append

* ***********************************************************************
* 1 - TZA 2010 (Wave 2) - Agriculture Section 5B 
* *********************1*************************************************
...
summarize 
sort hhid
customsave , idvar(crop_id) filename(AG_SEC5B.dta) path("$export") dofile(2010_AGSEC5B) user($user)
