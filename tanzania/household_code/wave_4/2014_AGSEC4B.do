...
* does
	* cleans Tanzania household variables, wave 4 Ag sec4b
...
* open log
	log using "$logout/wv4_AGSEC4B", append

* ***********************************************************************
* 1 - TZA 2014 (Wave 4) - Agriculture Section 4B 
* *********************1*************************************************
...
summarize 
sort crop_id
customsave , idvar(crop_id) filename(AG_SEC4B.dta) path("$export") dofile(2014_AGSEC4B) user($user)
