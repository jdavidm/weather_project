...
* does
	* loads Malawi cross sectional data
...
* define paths
	loc		source	= 	"G:/My Drive/weather_project/regression_data/malawi"
	loc		export 	= 	"G:/My Drive/weather_project/results_data/malawi/individual_results"
	loc		results = 	"G:/My Drive/weather_project/results_data/malawi"
	loc		logout 	= 	"G:/My Drive/weather_project/regression_data/logs"
...
* define local for all the files
	loc		fileList :	dir "`source'" files "cx*rf*.dta" 

* loop through all the files defined in the above local
	...
	* drop dry season values - we just focus on the rainy season (rs)
		keep		case_id- intyear rs_harvest_valuehaimp rsmz_harvestimp ///
					rsmz_cultivatedarea rs_cultivatedarea rs_irrigationany ///
					rs_fert_inorgpct rs_labordaysimp rs_herb rs_pest ///
					rsmz_irrigationany rsmz_fert_inorgpct rsmz_labordaysimp ///
					rsmz_herb rsmz_pest mean_season- dev_percent_raindays ///
					data- hhweight year
