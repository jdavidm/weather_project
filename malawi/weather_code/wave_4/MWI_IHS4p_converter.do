...
* does
	* reads in Malawi IHS4p, which we term wave 4, .csv files
...
* define paths
	loc root = "G:/My Drive/weather_project/weather_data/malawi/wave_4/raw"
	loc export = "G:/My Drive/weather_project/weather_data/malawi/wave_4/daily"
	loc logout = "G:/My Drive/weather_project/weather_data/malawi/logs"

* open log
	log using "`logout'/mwi_ihs4p_converter", replace
