...
* define paths
	loc root = "G:/My Drive/weather_project/weather_data/malawi/wave_1/raw"
	loc export = "G:/My Drive/weather_project/weather_data/malawi/wave_1/daily"
...
foreach folder of local folderList {
	...
	* save file
	customsave , idvar(case_id) filename("`dat'_`ext'_`sat'_daily.dta") ///
		path("`export'/`folder'") dofile(MWI_IHS3_converter) user(jdmichler)
	}
}
