...
* define paths	
	loc root = "G:/My Drive/weather_project/weather_data/malawi/wave_2/daily"
	loc export = "G:/My Drive/weather_project/weather_data/malawi/wave_2/refined"
	...
	foreach file in `fileList' {
		...
		* save file
		customsave , idvar(y2_hhid) filename("`dat'_`ext'_`sat'.dta") ///
			path("`export'/`folder'") dofile(MWI_IHPS_weather) user(jdmichler)
	}
}
