...
* define paths
	loc root = "G:/My Drive/weather_project/weather_data/malawi/wave_2/raw"
	loc export = "G:/My Drive/weather_project/weather_data/malawi/wave_2/daily"
...
foreach folder of local folderList {
	...
	* save file
	customsave , idvar(y2_hhid) filename("`dat'_`ext'_`sat'_daily.dta") ///
		path("`export'/`folder'") dofile(MWI_IHPS_converter) user(jdmichler)
	}
}
