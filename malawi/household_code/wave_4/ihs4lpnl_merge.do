...
* define paths
	loc		rootw 	= 	"G:/My Drive/weather_project/weather_data/malawi/wave_4/refined"
	loc		rooth 	= 	"G:/My Drive/weather_project/household_data/malawi/wave_4/refined"
	loc		export 	= 	"G:/My Drive/weather_project/merged_data/malawi/wave_4"
...
* define local with all files in each sub-folder	
	...
	* loop through each file in the above local
		...
		* drop variables for all years but 2015
			...
			drop 		mean_period_raindays_percent- dev_raindays_percent_2014 ///
						dev_raindays_percent_2016- dev_raindays_percent_2016
